...
@register_model('talkconv_lm')
class TaLKConvLanguageModel(FairseqLanguageModel):
    ...
    def build_model(cls, args, task):
        ...
        decoder = TaLKConvDecoder(args, task.output_dictionary, embed_tokens, no_encoder_attn=True, final_norm=False)
        return TaLKConvLanguageModel(decoder)


@register_model_architecture('talkconv_lm', 'talkconv_lm')
...
@register_model_architecture('talkconv_lm', 'talkconv_lm_big')
def talkconv_lm_big(args):
...
@register_model_architecture('talkconv_lm', 'talkconv_lm_wiki103')
def talkconv_lm_wiki103(args):
    args.decoder_layers = getattr(args, 'decoder_layers', 17)
    args.decoder_attention_heads = getattr(args, 'decoder_attention_heads', 16)
    ...
    args.decoder_glu = getattr(args, 'decoder_glu', True)
    args.decoder_kernel_size_list = getattr(args, 'decoder_kernel_size_list', [3, 5, 7, 15, 31, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63, 63])
    talkconv_lm_big(args)
